...
import { getEditProblemUrl, getSubmitProjectUrl } from '@/lib/airtable-forms';
          ...
          <div>
            ...
            {relatedProjects.length === 0 ? (
              <div className="rounded-lg p-6 text-center" style={{ backgroundColor: '#F7F0E8', border: '1px solid #E6C8A1' }}>
                ...
                <p className="text-sm mb-4" style={{ color: '#6B6764' }}>This is an opportunity for new initiatives!</p>
                <a
